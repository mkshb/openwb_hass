...
def update_vehicle_info(vehicle_id: int, name: str | None = None, manufacturer: str | None = None, model: str | None = None):
...
def update_vehicle_templates(vehicle_id: int, key: str, value):
    info = _vehicle_data.setdefault(vehicle_id, {})
    info[key] = value
